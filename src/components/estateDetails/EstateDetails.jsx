...
const EstateDetails = () => {
  ...
  return (
    <>
      <Helmet>
        <title>EliteEstates | Details</title>
      </Helmet>
      <div className="p-4 pt-24  md:p-24 flex flex-col lg:flex-row gap-5">
        <div className="md:w-full lg:w-1/2 animate__animated animate__backInLeft">
          <img src={image} className="w-full" alt="" />
        </div>
        <div className="md:w-full lg:w-1/2 animate__animated animate__backInRight">
